```markdown
# 🧠 LinusAI — Model Context Protocol OS (MCP)
...
👉 https://aymnsk.github.io/mentorOS/

🌐 **Backend (Replit API)**:  
👉 https://21f9505f-1c16-4cf0-b124-d8570113d6b9-00-dc4e2n37xko5.sisko.replit.dev/

🧠 **Hugging Face Projects**:  
👉 https://huggingface.co/spaces/aymnsk
...
4. UI uses a terminal-inspired design, enhanced with history, dropdown agent selector, and summarization
